...
_p[0] = {
     ...
     */
        function getConstructor(name) {
            ...
            }).replace(/-([a-z])/gi, function(match, c) {
...
_p[4] = {
    value: function(require) {
        var OPERATOR_LIST = _p.r(7), FUNCTION_LIST = _p.r(6), FUNCTION_HANDLER = _p.r(17), Utils = {
...
_p[32] = {
     ...
     */
        ...
        // 转换特殊的文本字符
        function transformSpecialCharacters(c) {
            if (c.indexOf("\\") === 0) {
                return c + "\\";
            }
            return c;
        ...
        function isSpecialCharacter(c) {
            if (c.indexOf("\\") === 0) {
                return !!SPECIAL_LIST[c.substring(1)];
            }
            return false;
        }
